...
<body>
    ...
    <main class="nosservice">
        ...
        <div class="raison">
            <div class="qualite">
                <p>Nous sommes une équipe de Techniciens et Administrateurs Réseau avec plusieurs années d'experience en :</p>
                <ul class="list">
                    <li><i class="ri-check-double-line"></i>Cablage</li>
                    <li><i class="ri-check-double-line"></i>Architecture Réseau</li>
                    <li><i class="ri-check-double-line"></i>Cisco CCNA</li>
