...
<body>
    ...
    <!--<section class="banniere" id="#banniere">-->
        ...
        <main class="nosservice">
            <div class="text_para">
                <h3>Nos services Infonuagique / cloud computing</h3>
                <p>
                    Adopter une nouvelle manière de travailler, réduire les dépenses informatiques..., 
                    fait évoluer les entreprises et leur permet d'être plus compétitives et productives 
                    dans un marché en perpétuelle évolution.
                    Confiez vos services infonuagiques à notre équipe professionnelle qui en assurera la gestion pour vous.
                </p>
            </div>
            ...
            <div class="raison">
                <div class="qualite">
                    <p>Nous sommes une équipe de spécialistes de l'infonuagique. Chacun de nous a une maîtrise 
                       des services infonuagiques et certifier avec les certifications les plus recherchées telles que. :</p>
                    <ul class="list">
                        <li><i class="ri-check-double-line"></i>Certification AWS</li>
                        <li><i class="ri-check-double-line"></i>Certification Azure</li>
                    </ul>
                </div>
                <div class="img">
                    <img src="./images/prof.jpg" alt="" class="service-img">
                </div>
            </div>
        </main>
