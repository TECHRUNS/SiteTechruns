    ...
    <!--<section class="banniere" id="#banniere">-->
        <div class="slider">
            <div class="messlides fade" style="display: block;">
                ...
                <img src="./images/Banner-code.jpg" style="width: 100%; height: 100%;" alt="">
            </div>
            <div class="messlides fade">
                ...
                <img src="./images/prof.jpg" style="width: 100%; height: 100%;" alt="">
            </div>
            <div class="messlides fade">
                <div class="test">
                    <h1>Teckruns</h1>
                    <p>Une équipe<br>des ingénieurs DevOps</p>
                </div>
                <img src="./images/devop.jpg" style="width: 100%; height: 100%;" alt="">
            </div>
            <div class="messlides fade">
                <div class="test">
                    <h1>Teckruns</h1>
                    <p>Une équipe<br>des administrateurs de base de Donnée</p>
                </div>
                <img src="./images/data.jpg" style="width: 100%; height: 100%;" alt="">
            </div>
